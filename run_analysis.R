...
X_train <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/train/X_train.txt", header = FALSE)
y_train <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/train/y_train.txt", header = FALSE)
subject_train <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/train/subject_train.txt", header = FALSE)

X_test <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/test/X_test.txt", header = FALSE)
y_test <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/test/y_test.txt", header = FALSE)
subject_test <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/test/subject_test.txt", header = FALSE)
...
features <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/features.txt")
...
activity_labels <- read.table("D:/Study/!coursera/R/3_Getting_and_Cleaning_Data/UCI HAR Dataset/activity_labels.txt")
